...
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=15, shuffle=False, num_workers=4, collate_fn=collate_fn)
test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=15, shuffle=False, num_workers=4, collate_fn=collate_fn)
